...
#
# EXPECTED_HEADERS = """
#     content-type, accept-ranges, etag, server,
#     x-couch-request-id, x-couch-update-newrev"""
#
# def setup_module():
...
#     db_path = "/" + SHARED_DB
#     allowed_methods = """
#         CONNECT, COPY, DELETE, GET, HEAD, OPTIONS, POST, PUT, TRACE
#     """
...
#         )
#         assert_that(
#             calling(srv.res.options) \
#                 .with_args("", headers={"Origin": origin}),
#             raises(HTTPError)
#         )
#         assert_that(
#             srv.res.get("", headers={"Origin": origin}),
